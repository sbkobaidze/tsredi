  ...
  return (
    <div className="relative">
      <div
        className={
          mobilenav +
          " mobile-nav w-full h-screen absolute text-center flex items-center justify-center bg-[#8A2BE2]  text-white z-20"
        }
      >
        <ul className={" block text-xl font-semibold"}>
          ...
          <Link to="/blog">
            <li className="mt-3">{t("blog.header")}</li>
          </Link>
          <li className="mt-3">
            <select
      ...
      <div className=" border-white text-white font-medium dark:bg-black   h-16 w-full flex justify-center font-main relative z-30">
        <div className="border-t-2 w-full m-2  px-5 pt-2 flex justify-between">
                    ...
                    <g>
                      ...
                      <g>
                        ...
                        <line
                          ...
                          y2="81.03"
                        />
                        <path className="cls-1" d="m86.3,75.02h18.98" />
                        <line
                          className="cls-1"
                          x1="85.42"
                          y1="68.4"
          ...
          <div className="  flex-row flex  items-center mt-1  ">
            <ul
              className={
                " flex-row sm:items-center hidden sm:flex font-semibold "
              }
            >
              <Link to="/#about">
