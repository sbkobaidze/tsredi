...
export const Career = ({ slice }) => {
  ...
  return (
    <div
      className="flex justify-center  w-full h-[auto] py-32  dark:bg-black font-main text-white text-semibold flex-col relative  "
      id="careers"
    >
      ...
      <div className="w-1/2 m-auto mt-10 z-20">
